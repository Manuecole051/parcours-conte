var ueMnuMgr = {
	...
	init : function() {
		...
		} catch(e){console.error("ERROR ueMnuMgr.init: "+e)}
	},
	onLoad : function() {
		try{
			// Add toggle button
		...
		} catch(e){console.error("ERROR ueMnuMgr.onLoad: "+e)}
	},
	loadSortKey : "AZ",
...
scSiRuleEnsureVisible.prototype.initTask = function(pTargetScrollTop) {
	...
	}catch(e){console.error("ERROR scSiRuleEnsureVisible.initTask: "+e);}
}
scSiRuleEnsureVisible.prototype.execTask = function() {
	...
	}catch(e){console.error("ERROR scSiRuleEnsureVisible.execTask: "+e);}
}
scSiRuleEnsureVisible.prototype.precipitateEndTask = function() {
	try{
		this.fContainer.scrollTop = this.fTargetScrollTop;
	}catch(e){console.error("ERROR scSiRuleEnsureVisible.precipitateEndTask: "+e);}
}
